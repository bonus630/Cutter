...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="dc693bfa-e2cf-42b3-a5f4-84414535609f"
                type="wpfhost"
                hostedType="Addons\Cutter\Cutter.dll,Cutter.ControlUI"
                enable="true"/>
    ...
    <xsl:copy>
      <xsl:apply-templates select="node()|@*"/>
        ...
        <container>
          ...
          <item dock="fill" margin="0,0,0,0" guidRef="dc693bfa-e2cf-42b3-a5f4-84414535609f"/>
        </container>
